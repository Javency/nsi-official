<template>
    <div class="consuleMain">
        ...
        <div class="item">
            <h3>新学说咨询</h3>
            <h3>NSI CONSULTANCY</h3>
            <p style="color:#333">帮助客户投资学校 、创建学校 、管理学校</p>
            <p style="color:#333">Helping clients with investing, establishing, and managing international schools.</p>
            <div class="itemInfor">
                <h4>(一) 新建校咨询</h4>
