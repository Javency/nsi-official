<template>
    <div class="researchIndex-com">
        <div class="banner text-center">
            <img src="../../assets/img/research/banner.jpg" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6 subItem pr7">
                            <img src="../../assets/img/research/subItem003.png" alt="">
                        ...
                        <div class="col-md-6 col-xs-6 subItem pl7">
                            <img src="../../assets/img/research/subItem004.png" alt="">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6 subItem pr7">
                            <img src="../../assets/img/research/subItem001.jpg" alt="">
                            <p class="subItem-title">探寻本质</p>
                            <p class="subItem-desc">国际化学校商业模式研究</p>
                        </div>
                        <div class="col-md-6 col-xs-6 subItem pl7">
                            <img src="../../assets/img/research/subItem002.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center research-title titleBg01">研究成果</h3>
                </div>
            </div>
            <div class="row pt30">
            ...
            <div class="row pt30">
                <div class="col-md-3 col-xs-6 reportlist">
                    <a href="http://class.xinxueshuo.cn/nsi-class/pages/mac.html" target="_blank">
                        <img src="../../assets/img/research/subItem01.jpg" alt="">
                    </a>
                ...
                <div class="col-md-3 col-xs-6 reportlist">
                    <a href="http://class.xinxueshuo.cn/nsi-class/pages/mac.html" target="_blank">
                        <img src="../../assets/img/research/subItem02.jpg" alt="">
                    </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center research-title titleBg03">新学说<span>四库全书</span></h3>
                </div>
            </div>
            <div class="row pt30">
                <div class="col-md-3 col-xs-6 reportlist">
                    <a href="http://data.xinxueshuo.cn/nsi/school/school.html" target="_blank">
                        <img src="../../assets/img/research/database01.jpg" alt="">
                    </a>
                ...
                <div class="col-md-3 col-xs-6 reportlist">
                    <a href="http://data.xinxueshuo.cn/nsi/company/company.html" target="_blank">
                        <img src="../../assets/img/research/database02.jpg" alt="">
                    </a>
                ...
                <div class="col-md-3 col-xs-6 reportlist">
                    <a href="http://data.xinxueshuo.cn/nsi/talent/talent.html" target="_blank">
                        <img src="../../assets/img/research/database03.jpg" alt="">
                    </a>
                ...
                <div class="col-md-3 col-xs-6 reportlist">
                    ...
                    <p class="subItem-title">国际学校项目库</p>
                    <p class="subItem-desc">新学说国际学校四库全书，为学校，机构，和从业者提供最权威的行业数据，最先进的行业服务</p>
                </div>
            </div>
            <!-- 新学说四库全书 END-->
        </div>
...
<style lang="scss">
    .researchIndex-com{
       ...
       .subItem-title{
        ...
        .titleBg01{
            background-image: url('../../assets/img/research/title03.png')
        }
        .titleBg02{
            background-image: url('../../assets/img/research/title01.png')
        }
        .titleBg03{
            background-image: url('../../assets/img/research/title02.png')
        }
        .reportItem{
            img{
                @media (max-width: 768px) {
