    ...
    <div class="ges-com">
        ...
        <div class="bgfa">
            <div class="container team-intro">
                <div class="row">
                    <div class="col-md-6">
                        <div class="team-nsi">
                            <h3 class="text-center">{{$t('ges.team')}}</h3>
                        </div>
        ...
        <div class="bgff">
            <div class="container nsi-cooperation">
                <div class="row">
                    <div>
                        <h3 class="text-center">{{$t('ges.partner')}}</h3>
                    </div>
                    <div>
                        <h3 class="coo-info"><small>{{$t('ges.partnerContent')}}</small></h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="bgfa">
            <div class="container ges">
                <div class="row">
                    <div class="col-md-6">
    ...
    .ges-com{
        ...
        .ges-bg{
            ...
            .cover-bg{
                ...
                left: 0;
                top: 0;
                background-color: rgba(32, 82, 143, 0.8);
                .container,.content{
                    height: 100%;
                    display: flex;
        ...
        .about-nsi,.team-nsi,.nsi-cooperation,.ges{
            color: #4A4F57;
            h3{
                font-size: 30px;
                max-width: 900px;
